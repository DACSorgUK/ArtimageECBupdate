...
public partial class CMSFormControls_DDExclusiveRightsToLicenece : FormEngineUserControl
{
    ...
    public override object[,] GetOtherValues()
    {
        ...
        array[0, 0] = "ExclusiveRightsToLicenece";
        array[0, 1] = GetValue();
        return array;
    }
    ...
    {
        if (ddExclusiveRightsToLicenece.SelectedValue == "-1")
        {
    ...
    {
        return ddExclusiveRightsToLicenece.SelectedValue;
    }
    #endregion

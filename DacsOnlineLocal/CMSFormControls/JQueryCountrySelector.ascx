<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JQueryCountrySelector.ascx.cs"
    Inherits="CMSFormControls_JQueryCountrySelector" %>

     <script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
	<script src="~/App_Themes/DACS/_js/_country/jquery-ui-autocomplete.js" type="text/javascript"></script>
	<script src="~/App_Themes/DACS/_js/_country/jquery.select-to-autocomplete.js" type="text/javascript"></script>
      ...
      color: #161A1C;
    	...
    	<script type="text/javascript" >
    	    	    $(document).ready(function () {
    	    	       $('#countryselectorDacs').selectToAutocomplete();
    	    	       });

	</script>


    <select name="Country" id="countryselectorDacs"  autocorrect="off" autocomplete="off" runat="server" clientidmode="Static" class="text" >
    </select>

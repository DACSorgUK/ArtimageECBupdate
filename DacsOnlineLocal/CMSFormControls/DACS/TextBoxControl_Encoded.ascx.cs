...
public partial class CMSFormControls_DACS_TextBoxControl_Encoded : FormEngineUserControl
{
    #region "Constants"
    ...
    public override object Value
    {
        get
        {
            if (Trim)
            {
                ...
                return HTMLHelper.HTMLEncode(textbox.Text.Trim());
            }
            else
            {
                return HTMLHelper.HTMLEncode(textbox.Text);
            }
        }
        set
        {
    ...
    public CMSFormControls_DACS_TextBoxControl_Encoded()
    {

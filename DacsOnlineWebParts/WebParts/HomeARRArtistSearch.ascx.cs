...
namespace DacsOnlineWebParts.WebParts
{
    ...
    public partial class HomeARRArtistSearch : MvpUserControl, IARRArtistSearchView
    {
        #region //Page Methods
        /// <summary>
        ...
        protected void btnSubmit_Click_Modal(object sender, EventArgs e)
        {
           ...
           string urlParaMeter = Artist_First_Name + "=" + txtArtistFirstName.Text.Trim() + "&" + Artist_Last_Name + "=" + txtArtistLastName.Text.Trim() + "&" + Year_Sale + "=" + ddYear.SelectedValue + "&PAGE_SIZE=" + PageSize;
        ...
        {
            get { return ValidationHelper.GetString(this.GetValue("ARRSubmitUrl"), ""); }
        }
        ...
        public void SetPagingControl(int totalItems, int recordsPerPage, int currentPage,string artistFirstName,string artistLastName,string Year)
        {
            ...
            //btTeanRecords.NavigateUrl = ArrSearchUrl + "?"+ Artist_First_Name + "=" + artistFirstName + "&" + Artist_Last_Name + "=" + artistLastName + "&" + Year_Sale + "=" + Year + "&PAGE_SIZE=10&CURRENT_PAGE=1" ;
            //btFiftyRecords.NavigateUrl = ArrSearchUrl + "?" + Artist_First_Name + "=" + artistFirstName + "&" + Artist_Last_Name + "=" + artistLastName + "&" + Year_Sale + "=" + Year + "&PAGE_SIZE=50&CURRENT_PAGE=1";

...
public partial class CMSFormControls_MultipleTextBox : FormEngineUserControl
{
    ...
    {
        get {
           return ValidationHelper.GetString(this.GetValue("HeaderText"), ""); 
        }
    }
    ...
    public string Note
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("Note"), "");
        }
    }
    ...
    {
        LbNote.Text = Note;
        Button1.Text = "+ Add another " + HeaderText;
        if (IsPostBack)
        {

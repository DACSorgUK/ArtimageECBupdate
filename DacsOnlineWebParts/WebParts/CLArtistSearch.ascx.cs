...
namespace DacsOnlineWebParts.WebParts
{
    ...
    public partial class CLArtistSearch : MvpUserControl, ICLArtistSearchView
    {
        #region //Page Methods
        /// <summary>
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            if (FilterOnClick != null)
            {
                string urlParaMeter = Artist_First_Name + "=" + Server.UrlEncode(txtArtistFirstName.Text.Trim()) + "&" + Artist_Last_Name + "=" + Server.UrlEncode(txtArtistLastName.Text.Trim()) + "&" + Year_Sale + "=" + YearSale + "&PAGE_SIZE=" + PageSize;
        ...
        protected void RepeterArtist_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            //    dataItem.YearOfBirth = "lived " + dataItem.YearOfBirth + "-";
            ...
            if (!string.IsNullOrEmpty(dataItem.YearOfBirth) && string.IsNullOrEmpty(dataItem.YearOfDeath))
                dataItem.YearOfBirth = "born in " + dataItem.YearOfBirth;
        ...
        {
            get { return ValidationHelper.GetString(this.GetValue("CLApplyUrl"), ""); }
        }
        ...
        public void Display(List<ArtistCLModel> artist)
        {
            ...
            else
            {
                ...
                ltlArtistName2.Text = ArtistFirstName + " " + ArtistLastName; 
        ...
        public void SetPagingControl(int totalItems, int recordsPerPage, int currentPage, string artistFirstName, string artistLastName, string Year)
        {
            ...
            btTeanRecords.NavigateUrl = CLSearchUrl + "?" + Artist_First_Name + "=" + Server.UrlEncode(artistFirstName) + "&" + Artist_Last_Name + "=" + Server.UrlEncode(artistLastName) + "&" + Year_Sale + "=" + Year + "&PAGE_SIZE=10&CURRENT_PAGE=1";
            btFiftyRecords.NavigateUrl = CLSearchUrl + "?" + Artist_First_Name + "=" + Server.UrlEncode(artistFirstName) + "&" + Artist_Last_Name + "=" + Server.UrlEncode(artistLastName) + "&" + Year_Sale + "=" + Year + "&PAGE_SIZE=50&CURRENT_PAGE=1";

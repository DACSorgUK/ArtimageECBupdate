<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CountrySelector.ascx.cs"
    Inherits="DacsOnlineWebParts.DacsOnlineControls.CountrySelector" %>
...
<select name="Country" id="countryselectorDacs"  class="text" autocorrect="off"
    autocomplete="off" runat="server" clientidmode="Static">
</select>
<%--<em class="red">
    <asp:CustomValidator ID="CustomCountryValidator" runat="server" ErrorMessage="This field is mandatory please enter" ControlToValidate="countryselectorDacs"></asp:CustomValidator>
</em>--%>
<%--   <option value="" selected="selected">Select Country</option>
      <option value="Afghanistan" data-alternative-spellings="AF افغانستان"> </option>

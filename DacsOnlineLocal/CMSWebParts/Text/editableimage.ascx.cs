                        ...
                        if (node.Attributes["name"] != null)
                        {
                            switch (node.Attributes["name"].Value.ToLower())
                            {
                                case "imagepath":
                                    ...
                                    if (Session["twitterMeta"] == null)
                                    {
                                        HtmlHead pHtml = Page.Header;
                                        string twitterTagName = "twitter:image";
                                        HtmlMeta meta = new HtmlMeta();
                                        meta.Name = twitterTagName;
                                        meta.Content = "https://test.dacs.org.uk"+path;
                                        pHtml.Controls.Add(meta);
                                        Session["twitterMeta"] = "1";
                                    }
